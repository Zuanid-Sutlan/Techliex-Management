    ...
    Scaffold(
        ...
        Column(
            ...
            Box(modifier = Modifier.fillMaxWidth().height(250.dp)) {
                val productBitmap = remember(order.productImage) { order.productImage.toBitmap() }
                if (productBitmap != null) {
                    Image(productBitmap.asImageBitmap(), null, Modifier.fillMaxSize(), contentScale = ContentScale.Crop)
                }
                IconButton(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                ...
                InfoSection(title = "Shipping Address", icon = Icons.Default.LocationOn) {
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        IconButton(
                            ...
                            Icon(Icons.Default.ContentCopy, contentDescription = null, tint = Color.Yellow)
                        }
                    }
                }
                ...
                if (order.trackId.isNotEmpty()) {
                    InfoSection(title = "Logistics", icon = Icons.Default.LocalShipping) {
                ...
                val paymentBitmap = remember(order.paymentImage) { order.paymentImage.toBitmap() }
                Card(
                    ...
                    if (paymentBitmap != null) {
                        Image(paymentBitmap.asImageBitmap(), null, Modifier.fillMaxSize(), contentScale = ContentScale.Fit)
                    }
                }
            }
        }
