...
import androidx.compose.material.icons.Icons
import androidx.compose.material.icons.filled.*import androidx.compose.material3.TextField
import androidx.compose.material.icons.Icons
import androidx.compose.material.icons.filled.*import androidx.compose.material3.TextFieldDefaults
...
import management.app.generated.resources.Res
import management.app.generated.resources.techliex_logo
...
fun LoginScreen(
    ...
    // Handle back button on Android (multiplatform friendly)
    // CommonMain doesn't have BackHandler or Activity.finishAffinity()
    // For Desktop, window close handles exit. For Android, we can handle it at MainActivity level.
    ...
    Column(
        ...
        Image(
            painter = painterResource(Res.drawable.techliex_logo),
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(onClick = { onAction(LoginScreenAction.OnPasswordVisibilityClicked) }) {
                    Icon(
                        imageVector = if (state.isPasswordVisible) Icons.Default.Info else Icons.Default.Lock,
